...
function Personal() {
  return (
    ...
    <div className={styles.experienceBox}>
        ...
        Mitt namn är Sebastian Torneus och jag går just nu utbildningen Frontend /App Developer hos Changemaker Educations. Jag är 32 år gammal och har under större delen av mitt arbetsliv kört lastbil för Home2you i Stockholm. Senaste åren har jag bott en del i Jukkasjärvi där jag jobbat med egna projekt kopplat till hus och skog samt Postnord.
<br></br>
<br></br>
